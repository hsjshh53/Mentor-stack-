        ...
        <div className="flex items-center gap-3 flex-1 md:flex-none justify-end">
          <div className="relative flex-grow md:flex-grow-0">
            ...
            <input 
              ...
              className="bg-white/5 border border-white/10 rounded-2xl pl-12 pr-6 py-2.5 text-sm focus:outline-none focus:border-[#F27D26]/50 transition-all w-full md:w-64"
            />
          </div>
          <Button 
